...
def carregar_e_limpar_financeiro():
    ...
    # --- CORREÇÃO 1: Ordenar os dados brutos por data ---
    # Isso evita que o gráfico fique "rabiscado" se o CSV original estiver bagunçado
...
if not df_financeiro_filtrado.empty:
    ...
    # --- CORREÇÃO 2: Ordenar a tabela agregada por Mês antes de fazer o gráfico ---
    # Isso é fundamental para o Plotly desenhar a linha na ordem certa
...
if not df_filtrado_agregado.empty and len(df_filtrado_agregado) >= 1:
    ...
    # Garante formatação de data no eixo X
